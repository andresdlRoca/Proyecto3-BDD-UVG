...
def top5_per_hour():
    ...
    entryarea9 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea9.place(relx=0.25, rely=0.12, anchor="center")
    entryarea10 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea10.place(relx=0.45, rely=0.12, anchor="center")
    entryarea11 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea11.place(relx=0.65, rely=0.12, anchor="center")
    entryarea12 = tk.Canvas(window, width=300, height=200, bg=foreground)
    ...
    entryarea13 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea13.place(relx=0.25, rely=0.37, anchor="center")
    entryarea14 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea14.place(relx=0.45, rely=0.37, anchor="center")
    entryarea15 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea15.place(relx=0.65, rely=0.37, anchor="center")
    entryarea16 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea16.place(relx=0.85, rely=0.37, anchor="center")
    ...
    entryarea17 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea17.place(relx=0.25, rely=0.62, anchor="center")
    entryarea18 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea18.place(relx=0.45, rely=0.62, anchor="center")
    entryarea19 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea19.place(relx=0.65, rely=0.62, anchor="center")
    entryarea20 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea20.place(relx=0.85, rely=0.62, anchor="center")
    ...
    entryarea21 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea21.place(relx=0.25, rely=0.87, anchor="center")
    entryarea22 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea22.place(relx=0.45, rely=0.87, anchor="center")
    entryarea23 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea23.place(relx=0.65, rely=0.87, anchor="center")
    entryarea24 = tk.Canvas(window, width=300, height=200, bg=foreground)
    entryarea24.place(relx=0.85, rely=0.87, anchor="center")
